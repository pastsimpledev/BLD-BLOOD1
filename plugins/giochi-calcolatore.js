...
const commandConfig = {
    ...
    lesbiometro: { title: 'LESBO-SCAN', themeColors: ['#FF1493', '#4B0082'], getDescription: p => p > 80 ? "Vibe da Girl Power assoluto!" : p > 50 ? "Sguardo magnetico!" : "Solo amiche?" },
    masturbometro: { title: 'FAP-METER', themeColors: ['#FF4500', '#2F4F4F'], getDescription: p => p > 80 ? "Chiama un idraulico per quel braccio!" : p > 50 ? "Sessioni intense, eh?" : "Santo subito." },
    fortunometro: { title: 'LUCK-DETECTOR', themeColors: ['#00FF00', '#004400'], getDescription: p => p > 80 ? "Vai a giocare al superenalotto!" : p > 50 ? "La fortuna ti sorride." : "Oggi meglio stare a letto." },
    intelligiometro: { title: 'BRAIN-METER', themeColors: ['#00FFFF', '#00008B'], getDescription: p => p > 80 ? "Elon Musk levati proprio!" : p > 50 ? "Cervello in fiamme!" : "Caricamento neuroni fallito." },
    bellometro: { title: 'BEAUTY-CHECK', themeColors: ['#FFD700', '#8B4513'], getDescription: p => p > 80 ? "Specchio delle mie brame!" : p > 50 ? "Uno schianto!" : "Punta sulla simpatia." },
    sottomessometro: { title: 'SUB-SCANNER', themeColors: ['#C0C0C0', '#2C3E50'], getDescription: p => p > 80 ? "Ti piace proprio stare ai piedi di qualcuno!" : p > 50 ? "Un sottomesso nato." : "Sei tu che porti il guinzaglio!" }
};
